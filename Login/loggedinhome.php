...
<header>
    ...
    <nav class="navbar">
        ...
        if (isset($_SESSION['usersuid'])) {
            echo "<a href='profile.php'>Hello, " . htmlspecialchars($_SESSION['usersuid']) . "!</a>";
...
<section class="footer">
    <div class="box-container">
        ...
        <div class="box">
            <h3>contact info</h3>
            <a href="https://github.com/nadhirhn8">GitHub</a>
